...
#if defined(MYVRML_SUPPORT_JSAI)
	delete mJNode;	mJNode = NULL;
#endif

	delete mName;	mName = NULL;
	delete mExposedField;		mExposedField	= NULL;
	delete mEventInField;		mEventInField	= NULL;
	delete mEventOutField;		mEventOutField	= NULL;
	delete mField;				mField	= NULL;
	delete mPrivateField;		mPrivateField	= NULL;
	delete mPrivateNodeVector;	mPrivateNodeVector	= NULL;
	delete mChildNodes;			mChildNodes		= NULL;
	delete mInitialized;		mInitialized	= NULL;
}
...
{
	int nLen = strlen(indentString1)+strlen(indentString2)+1;
	char *indentString = new char[nLen];
