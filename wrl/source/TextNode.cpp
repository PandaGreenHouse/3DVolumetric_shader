...
OGLFontOutline *TextNode::getOGLFontOutlines() const
{
	return mOGLFontOutlines.getNodes();
}

OGLFontOutline *TextNode::getOGLFontOutline(int family, int style) const
{
...
int TextNode::getNOGLFontOutlines() const
{
...
#if !defined(MYVRML_SUPPORT_GLUT)
	LOGFONT lf;
...
int OGLFontOutline::getFamily() const
{
	return mFamily;
}
...
int OGLFontOutline::getStyle() const
{
	return mStyle;
}
...
int OGLFontOutline::getListBaseID() const
{
	return mListBaseID;
}

OGLFontOutline *OGLFontOutline::next() const
{
	return ((LinkedListNode<OGLFontOutline>*)this)->next(); 
}
