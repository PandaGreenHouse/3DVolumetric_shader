...
void MFVec3f::get1Value(int index, float value[]) const
{
	const SFVec3f *vector = (SFVec3f *)getObject(index);
	if (vector)
...
void MFVec3f::outputContext(std::ostream& printStream, const char *indentString) const
{
	float value[3];
