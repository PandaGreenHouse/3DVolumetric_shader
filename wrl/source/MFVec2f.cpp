...
void MFVec2f::get1Value(int index, float value[]) const
{
	const SFVec2f *vector = (SFVec2f *)getObject(index);
	if (vector)
...
void MFVec2f::outputContext(std::ostream& printStream, const char *indentString) const
{
	float value[2];
