...
std::ostream& MyVrml::operator<<(std::ostream &s, const SFFloat &value) 
{
...
const char *SFFloat::getValue(char *buffer, int bufferLen) const
{
...
bool SFFloat::equals(Field *field) const
{
