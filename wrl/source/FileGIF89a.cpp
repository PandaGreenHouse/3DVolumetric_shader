...
void FileGIF89a::getColor(int n, unsigned int index, RGBColor24 color) const
{
	if (image[n].localColorTable) {
...
void FileGIF89a::outputFirstData(int nImage, unsigned int tableIndex) const
{
...
void FileGIF89a::outputData(int nImage, unsigned int tableIndex) const
{
	assert(tableIndex < getLzwTableIndex());
...
void FileGIF89a::outputData(int nImage, unsigned int sindex, unsigned int cindex) const
{
	for (unsigned int n=0; n<lzwTable[sindex].n; n++) {
...
void FileGIF89a::printHeaderInfo() const
{
...
void FileGIF89a::printImageInfo(int n) const
{
