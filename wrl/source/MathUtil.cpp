...
void MyVrml::VectorNormalize(float vector[3])
{
...
float MyVrml::VectorGetLength(float vector[3])
{
...
void MyVrml::VectorInverse(float vector[3])
{
	vector[0] = -vector[0];
	vector[1] = -vector[1];
	vector[2] = -vector[2];
...
void MyVrml::VectorGetDirection(
float	point1[3], 
float	point2[3],
float	vector[3])
{
...
void MyVrml::GetNormalFromVertices(float point[3][3], float resultVector[3])
{
...
void MyVrml::GetPlaneVectorFromTwoVectors(float vector1[3], float vector2[3], float resultVector[3])
{
