...
void MyVrml::SetParserResultObject(ParserResult *result)
{
	gParserResult = result;
}

ParserResult *MyVrml::GetParserResultObject()
{
...
void MyVrml::PushParserObject(Parser *parser)
{
	gParserList.addNode(parser);
}

void MyVrml::PopParserObject()
{
	Parser *lastNode = gParserList.getLastNode(); 
	lastNode->remove();
}

Parser *MyVrml::GetParserObject()
{
	return gParserList.getLastNode(); 
}

int MyVrml::ParserGetCurrentNodeType(void)
{
	return GetParserObject()->getCurrentNodeType();
}

int MyVrml::ParserGetParentNodeType(void)
{
	return GetParserObject()->getPrevNodeType();
}

Node *MyVrml::ParserGetCurrentNode(void)
{
	return GetParserObject()->getCurrentNode();
}

void MyVrml::ParserPushNode(int parserType, Node *node)
{
	GetParserObject()->pushNode(node, parserType);
}

void MyVrml::ParserPushNode(Node *node)
{
	GetParserObject()->pushNode(node, UNKNOWN_NODE);
}

void MyVrml::ParserPopNode(void)
{
	GetParserObject()->popNode();
}

void MyVrml::ParserAddNode(Node *node)
{
...
void MyVrml::ParserAddRouteInfo(const char *string)
{
...
Node *MyVrml::CreateNode(int nodeType)
{
	switch (nodeType) {
		case ANCHOR_NODE:
...
Node *MyVrml::CreateX3DNode(int nodeType)
{
