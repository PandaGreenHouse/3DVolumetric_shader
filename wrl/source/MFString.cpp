...
const char *MFString::get1Value(int index) const
{
...
void MFString::setValue(int size, const char *values[])
{
	clear();
...
void MFString::outputContext(std::ostream& printStream, const char *indentString) const
{
