...
const char *SFString::getValue() const
{
...
std::ostream& MyVrml::operator<<(std::ostream &s, const SFString &string) 
{
	if (string.getValue())
...
const char *SFString::getValue(String &buffer) const
{
	buffer.setValue(getValue());
	return buffer.getValue();
}

const char *SFString::getValue(char *buffer, int bufferLen) const
{
...
bool SFString::equals(Field *field) const
{
