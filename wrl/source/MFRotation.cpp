...
*
*	03/30/04
*		- Dimitris Bozelos <abchboz@yahoo.gr>
*		- Fixed a buffer of setValue(MFRotation *) to float[4];
*
******************************************************************/
...
void MFRotation::get1Value(int index, float value[]) const
{
...
{
	clear();
	// Thanks for Dimitris Bozelos (03/30/04)
	float value[4];
...
void MFRotation::outputContext(std::ostream& printStream, const char *indentString) const
{
	float value[4];
