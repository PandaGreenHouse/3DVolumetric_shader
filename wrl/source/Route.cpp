...
Node *Route::getEventOutNode() const
{ 
	return mEventOutNode; 
}

Node *Route::getEventInNode() const
{ 
	return mEventInNode; 
}
...
Field *Route::getEventOutField() const
{ 
...
Field *Route::getEventInField() const
{ 
...
void Route::output(std::ostream& printStream) const
{
...
void Route::outputXML(std::ostream& printStream)  const
{
	if (!getEventOutNode() && !getEventOutField() && !getEventInNode() && !getEventInField())
		return;
