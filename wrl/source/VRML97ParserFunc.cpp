...
void MyVrml::AddSFColor(float color[3])
{
...
void MyVrml::AddSFRotation(float rotation[4])
{	
    switch (ParserGetCurrentNodeType()) {
...
void MyVrml::AddSFVec3f(float vector[3])
{	
    switch (ParserGetCurrentNodeType()) {
	case VRML97_NORMAL:
		{
...
void MyVrml::AddSFVec2f(float vector[2])
{	
	switch (ParserGetCurrentNodeType()) {
...
void MyVrml::AddSFInt32(int	value)
{	
    switch (ParserGetParentNodeType()) {
...
void MyVrml::AddSFFloat(float value)
{	
    switch (ParserGetCurrentNodeType()) {
...
void MyVrml::AddSFString(const char *string)
{	
	switch (ParserGetCurrentNodeType()) {
...
const char *MyVrml::GetDEFSrting(
const char *name)
{
...
void MyVrml::SetDEFName(const char *name)
{
	((VRML97Parser *)GetParserObject())->setDefName(name);
}

const char *MyVrml::GetDEFName(void)
{
